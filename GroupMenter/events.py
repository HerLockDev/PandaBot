...
from GroupMenter import MONGO_DB_URI
from GroupMenter import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"GroupMenter/modules/{shortname}.py")
        name = "GroupMenter.modules.{}".format(shortname)
